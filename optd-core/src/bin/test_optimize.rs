...
use optd_core::{
    ...
    plan_nodes::{ConstantExpr, JoinType, LogicalJoin, LogicalScan, OptRelNode},
    rel_node::Value,
...
pub fn main() {
    ...
    let cond = ConstantExpr::new(Value::Bool(true));
    optimizer
        .optimize(
            LogicalJoin::new(scan1.0, scan2.0, cond.0, JoinType::Inner)
                .0
                .into_rel_node(),
        )
        .unwrap();
